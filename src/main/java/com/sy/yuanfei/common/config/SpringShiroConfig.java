...
import com.sy.yuanfei.common.realm.MyJdbcRealm1;
...
public class SpringShiroConfig {
    ...
    public Realm createRealm(@Autowired DataSource dataSource){
        MyJdbcRealm1 realm = new MyJdbcRealm1();
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Autowired SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("http://127.0.0.1:8080/html/login.html");
        //拦截器.
